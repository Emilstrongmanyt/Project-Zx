...
namespace ProjectZx.Core
{
    ...
    public static class Achievements
    {
        ...
        static readonly AchievementDef[] Catalog =
        {
            ...
            new(AchievementId.DungeonDelver, "Dungeon Delver", "Clear Emberwilds round 20 and enter the door to the Warded Halls."),
            new(AchievementId.InsideArcher, "Inside Archer", "Clear round 30 in the Warded Halls."),
            new(AchievementId.TogetherAgain, "Together Again", "Meet RowZi at the Emberwilds round 20 door."),
            new(AchievementId.DungeonClearer, "Dungeon Clearer", "Defeat the Ironvault round 40 boss and enter the Silent Ossuary portal."),
            new(AchievementId.CryptClearer, "Crypt Clearer", "Defeat the Silent Ossuary round 50 Minotaur and enter the victory portal."),
            new(AchievementId.EndlessHorizon, "Endless Horizon", "Unlock The Endless Front after clearing Silent Ossuary round 50."),
            new(AchievementId.IronArsenal, "Iron Arsenal", "Unlock Iron for a weapon type (Ironvault R30 with that class)."),
            new(AchievementId.SteelArsenal, "Steel Arsenal", "Unlock Steel for a weapon type (Endless Front R20 with that class)."),
            new(AchievementId.CopperArsenal, "Copper Arsenal", "Unlock Copper for a weapon type (Endless Front R30 with that class)."),
            new(AchievementId.SilverArsenal, "Silver Arsenal", "Unlock Silver for a weapon type (Endless Front R40 with that class)."),
            new(AchievementId.GoldArsenal, "Gold Arsenal", "Unlock Gold for a weapon type (50,000 kills with that weapon)."),
            new(AchievementId.CobaltArsenal, "Cobalt Arsenal", "Unlock Cobalt for a weapon type (Endless Front R60 with that class)."),
            new(AchievementId.PlatinumArsenal, "Platinum Arsenal", "Unlock Platinum for a weapon type (Endless Front R70 with that class)."),
            new(AchievementId.AdamantineArsenal, "Adamantine Arsenal", "Unlock Adamantine for a weapon type (Endless Front R80 with that class)."),
            new(AchievementId.CrimsonArsenal, "Crimson Arsenal", "Unlock Crimson for a weapon type (Endless Front R90 with that class)."),
            new(AchievementId.FatefulArsenal, "Fateful Arsenal", "Unlock Fateful for a weapon type (Endless Front R100 with that class).")
        };
        ...
        {
            if (WeaponCatalog.AnyClassHasTier(WeaponMaterialTier.Iron))
                TryUnlock(AchievementId.IronArsenal);
            if (WeaponCatalog.AnyClassHasTier(WeaponMaterialTier.Steel))
                TryUnlock(AchievementId.SteelArsenal);
            if (WeaponCatalog.AnyClassHasTier(WeaponMaterialTier.Copper))
                TryUnlock(AchievementId.CopperArsenal);
            if (WeaponCatalog.AnyClassHasTier(WeaponMaterialTier.Silver))
                TryUnlock(AchievementId.SilverArsenal);
            if (WeaponCatalog.AnyClassHasTier(WeaponMaterialTier.Gold))
                TryUnlock(AchievementId.GoldArsenal);
            if (WeaponCatalog.AnyClassHasTier(WeaponMaterialTier.Cobalt))
                TryUnlock(AchievementId.CobaltArsenal);
            if (WeaponCatalog.AnyClassHasTier(WeaponMaterialTier.Platinum))
                TryUnlock(AchievementId.PlatinumArsenal);
            if (WeaponCatalog.AnyClassHasTier(WeaponMaterialTier.Adamantine))
                TryUnlock(AchievementId.AdamantineArsenal);
            if (WeaponCatalog.AnyClassHasTier(WeaponMaterialTier.Crimson))
                TryUnlock(AchievementId.CrimsonArsenal);
            if (WeaponCatalog.AnyClassHasTier(WeaponMaterialTier.Fateful))
                TryUnlock(AchievementId.FatefulArsenal);
        }
